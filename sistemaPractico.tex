...
% Operadores matemáticos en español
...
% ============================================================
% ÍNDICE DE FIGURAS PERSONALIZADO PARA PSEINT
% ============================================================
\newcounter{ejecucion}

\makeatletter
\newcommand{\listadefiguraspseint}{%
	\section*{Índice de figuras PSeInt}
	\addcontentsline{toc}{section}{Índice de figuras PSeInt}
	\@starttoc{toe}
}
\makeatother
	...
	\begin{textblock*}{18cm}(0.1cm,13cm)
		...
		{\color{white}
			...
			{\fontsize{20}{24}\selectfont
				\bfseries SISTEMA MULTITAREA\par}
...
\begin{titlepage}
	...
	\begin{minipage}{0.95\textwidth}
		...
		{\Large\color{azulUNEMI}
			\hspace*{1cm}Albán Coello Diego Andrés\\
			\hspace*{1cm}Ayala Pérez Ana Gabriela\\
			\hspace*{1cm}\color{azulUNEMI}Bueno Pincay Solange Marisol\\
			\hspace*{1cm}\color{azulUNEMI}Calero Maldonado Ángel Fernando\\
			\hspace*{1cm}\color{azulUNEMI}Dutan Bonilla Ronald Miguel\\
			\hspace*{1cm}\color{azulUNEMI}González Estrada Ángel Omar \color{red} (NO TRABAJÓ)\\
			\hspace*{1cm}\color{azulUNEMI}Proaño Alcivar Roberto Celestino\\
			\hspace*{1cm}\color{azulUNEMI}Villega Segura Israel Alfonso \color{red}(NO TRABAJÓ)}
		
		\vspace{1.2cm}
		
		{\Large\color{naranjaUNEMI}
			\textbf{Asignatura:}}
		{\Large\color{azulUNEMI} Fundamentos De La Programación}\\
		
		{\Large\color{naranjaUNEMI}
			\textbf{Docente:}}
		{\Large\color{azulUNEMI} PhD. Freire Avilés Roger Marcelo}\\
		...
		{\Large\color{naranjaUNEMI}
			\textbf{Código:}}
		{\Large\color{azulUNEMI} S7-COMPONENTEPRACTICO-1}\\
		
		{\Large\color{naranjaUNEMI}
			\textbf{Fecha de entrega:}}
		{\Large\color{azulUNEMI} 11 de Junio de 2026}
